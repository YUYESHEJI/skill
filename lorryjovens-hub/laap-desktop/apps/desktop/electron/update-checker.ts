...
const RELEASES_URL =
  "https://api.github.com/repos/lorryjovens-hub/laap-desktop/releases?per_page=1";
const RELEASES_PAGE = "https://github.com/lorryjovens-hub/laap-desktop/releases";
