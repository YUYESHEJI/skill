...
export function CockpitIcon() {
  return (
    <Icon>
      ...
      <path d="M8 11.5v2.6M8 1.9v2.6M3.4 3.4l1.9 1.9M10.7 10.7l1.9 1.9M3.4 12.6l1.9-1.9M10.7 5.3l1.9-1.9" stroke="currentColor" strokeLinecap="round" strokeWidth="1.3" />
    </Icon>
  );
}
