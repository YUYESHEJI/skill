...
export function SettingsNotificationsSection({
  ...
  return (
    <>
      <SettingsGroup title="System" description="macOS decides whether LAAP can show desktop notifications at all.">
        ...
        {showRecoveryActions ? (
          <SettingsRow
            ...
            description={
              showAskMacOs
                ? "LAAP asks macOS when active work first moves into the background. You can also ask now."
                : "macOS notifications are already turned off for LAAP. Open System Settings to enable them again."
            }
          >
...
function descriptionForPermissionStatus(status: DesktopNotificationPermissionStatus): string {
  switch (status) {
    case "granted":
      return "macOS will allow LAAP to show desktop notifications for background thread updates.";
    case "denied":
      return "macOS notifications are turned off for LAAP. Enable them in System Settings to receive background completion alerts.";
    case "default":
      return "LAAP has not asked macOS for desktop notification access yet.";
    case "unsupported":
      return "Desktop notifications are unavailable on this system.";
    default:
      return "Checking whether macOS notifications are available for LAAP.";
  }
}
